...
#### Operation Deadlock: C2 Infiltration
[Operation Deadlock: C2 Infiltration](https://tryhackme.com/room/deadlockc2)

This is the one TryHackMe challenge that kind of takes a bunch of my time. So I decided to give it another try after the competition ended.

A teammate did make some progress already, but I do want to solve this on my own from the beginning. 

(Will update this later if I solve it)